...
//laravel 10 . check if current user logged in
$loggedIn = Auth::check();
        ...
        <ul class="pb-2 space-y-2">
          <li>
            <a href="https://flowbite-admin-dashboard.vercel.app/settings/" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 ">
                ...
                <!-- check if current user is admin, link to admin settings -->
          ...
          <li>
            ...
            <ul id="dropdown-pages" class="hidden py-2 space-y-2">
              <li>
                <a href="{{ route('admin.schools_institutions.index') }}" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">{{ __('Sekolah') }}</a>
              </li>
              <li>
