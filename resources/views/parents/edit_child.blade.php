<x-app-layout>
    ...
    <script>
        ...
        document.getElementById('childForm').addEventListener('reset', function(event) {
            document.getElementById('child_name').value = originalValues.childName;
            document.getElementById('email').value = originalValues.email;
            document.getElementById('dob').value = originalValues.dob;
            document.getElementById('child_gender').value = originalValues.childGender;
            // Reset the picture input field (not possible with JavaScript alone, as it's a file input)
        });
